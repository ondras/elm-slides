...
var _ondras$elm_slides$Types$Slide = F2(
	function (a, b) {
		return {title: a, node: b};
	});
var _ondras$elm_slides$Types$Data = F2(
	function (a, b) {
		return {slides: a, index: b};
	});

var _ondras$elm_slides$Msg$Last = {ctor: 'Last'};
var _ondras$elm_slides$Msg$First = {ctor: 'First'};
var _ondras$elm_slides$Msg$Next = {ctor: 'Next'};
var _ondras$elm_slides$Msg$Prev = {ctor: 'Prev'};
var _ondras$elm_slides$Msg$Go = function (a) {
	return {ctor: 'Go', _0: a};
};
var _ondras$elm_slides$Msg$Response = function (a) {
...
var _ondras$elm_slides$Keys$next = _elm_lang$core$Set$fromList(
	_elm_lang$core$Native_List.fromArray(
		[32, 34, 39, 40]));
var _ondras$elm_slides$Keys$prev = _elm_lang$core$Set$fromList(
	_elm_lang$core$Native_List.fromArray(
		[8, 33, 37, 38]));
var _ondras$elm_slides$Keys$keysToMessage = function (keyCode) {
	return _elm_lang$core$Native_Utils.eq(keyCode, 36) ? _ondras$elm_slides$Msg$First : (_elm_lang$core$Native_Utils.eq(keyCode, 35) ? _ondras$elm_slides$Msg$Last : (A2(_elm_lang$core$Set$member, keyCode, _ondras$elm_slides$Keys$prev) ? _ondras$elm_slides$Msg$Prev : (A2(_elm_lang$core$Set$member, keyCode, _ondras$elm_slides$Keys$next) ? _ondras$elm_slides$Msg$Next : _ondras$elm_slides$Msg$NoOp)));
};
var _ondras$elm_slides$Keys$subscription = _elm_lang$keyboard$Keyboard$downs(_ondras$elm_slides$Keys$keysToMessage);

var _ondras$elm_slides$Parser$lastSubmatch = function (match) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_elm_lang$core$Maybe$Just(''),
		_elm_lang$core$List$head(
			_elm_lang$core$List$reverse(match.submatches)));
};
var _ondras$elm_slides$Parser$options = _elm_lang$core$Native_Utils.update(
	_evancz$elm_markdown$Markdown$defaultOptions,
	{smartypants: true});
var _ondras$elm_slides$Parser$pattern = {
	$break: _elm_lang$core$Regex$regex('\\n-+8<-+'),
	title: _elm_lang$core$Regex$regex('(\\n|^)\\s*#\\s+([^\\n]+)')
};
var _ondras$elm_slides$Parser$title = function (str) {
	var matches = A3(
		_elm_lang$core$Regex$find,
		_elm_lang$core$Regex$AtMost(1),
		_ondras$elm_slides$Parser$pattern.title,
		str);
	...
	if (_p0.ctor === 'Nothing') {
		...
		return A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			_ondras$elm_slides$Parser$lastSubmatch(_p0._0));
	}
};
var _ondras$elm_slides$Parser$slide = function (str) {
	return A2(
		_ondras$elm_slides$Types$Slide,
		_ondras$elm_slides$Parser$title(str),
		A3(
			_evancz$elm_markdown$Markdown$toHtmlWith,
			_ondras$elm_slides$Parser$options,
			_elm_lang$core$Native_List.fromArray(
				[]),
			str));
};
var _ondras$elm_slides$Parser$parse = function (str) {
	return A2(
		_elm_lang$core$List$map,
		_ondras$elm_slides$Parser$slide,
		A3(_elm_lang$core$Regex$split, _elm_lang$core$Regex$All, _ondras$elm_slides$Parser$pattern.$break, str));
};

var _ondras$elm_slides$Request$responseFail = function (err) {
	return _ondras$elm_slides$Msg$Response(
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _ondras$elm_slides$Request$responseOk = function (data) {
	return _ondras$elm_slides$Msg$Response(
		_ondras$elm_slides$Parser$parse(data));
};
var _ondras$elm_slides$Request$command = function (url) {
	return A3(
		_elm_lang$core$Task$perform,
		_ondras$elm_slides$Request$responseFail,
		_ondras$elm_slides$Request$responseOk,
		_evancz$elm_http$Http$getString(url));
};

var _ondras$elm_slides$View$slide = F3(
	function (current, index, slide) {
		return A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'active',
							_1: _elm_lang$core$Native_Utils.eq(index, current)
						},
...
var _ondras$elm_slides$View$slides = function (data) {
	return A2(
		_elm_lang$core$List$indexedMap,
		_ondras$elm_slides$View$slide(data.index),
		data.slides);
};
var _ondras$elm_slides$View$all = function (data) {
	return A2(
		_elm_lang$html$Html_App$map,
		_elm_lang$core$Basics$always(_ondras$elm_slides$Msg$NoOp),
		A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_ondras$elm_slides$View$slides(data)));
};
var _ondras$elm_slides$View$display = F2(
	...
	function (oldIndex, msg, slides) {
		...
		switch (_p1.ctor) {
			...
			case 'First':
				return 0;
			case 'Last':
				return _elm_lang$core$List$length(slides) - 1;
			case 'Prev':
				return oldIndex - 1;
			case 'Next':
				return oldIndex + 1;
...
var _ondras$elm_slides$Main$update = F2(
	function (msg, data) {
		var index = A3(_ondras$elm_slides$Main$newIndex, data.index, msg, data.slides);
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'NoOp':
				return A2(
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _ondras$elm_slides$Main$main === 'undefined' ? null : _ondras$elm_slides$Main$main);
